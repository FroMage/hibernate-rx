 ...
 */
public class RxEntityUpdateAction extends EntityAction {
	...
	public void execute() throws HibernateException {
		...
		updateAR.thenApply( res -> {
			...
			return null;
		} ).whenComplete( (postUpdateAR, postUpdateErr) -> {
			if ( postUpdateErr != null ) {
				this.updateStage.toCompletableFuture().completeExceptionally( postUpdateErr );
			}
			else {
				this.updateStage.toCompletableFuture().complete( null );
			}
		} );
	}

...
/**
 * Descriptor for the mapping of a {@link io.reactiverse.pgclient.PgResult} providing
 * support for delayed resolution if needed.
 */
public interface PgResultMappingDescriptor {
	 ...
	 * JPA.
	 *
	 * @param rxResultsMetadata Access to information about the underlying results
	 * @param sessionFactory
	 * @return The resolved result references
	 */
	ResultSetMapping resolve(RxValuesMetadata rxValuesMetadata, SessionFactoryImplementor sessionFactory);
}
